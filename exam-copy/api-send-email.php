...
$sActivationKey = $jData->agents->$sAgentId->ActivationKey;
...
try {
    ...
    // Content
    $mail->isHTML(true);
    $sPath =  "http://localhost/exam/api-activate-account.php?id=$sAgentId&key=$sActivationKey";                              // Set email format to HTML
